...
Created FreeIPA groups to simulate organization departments
...
Created and assigned realistic users to groups
...
Created an HBAC (Host Based Access Control) rule to restrict which goups can SSH into a specific group of servers
